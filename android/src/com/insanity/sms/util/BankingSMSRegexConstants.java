...
public class BankingSMSRegexConstants {
	...
	public static List<String> smsOperatorCodes = Arrays.asList(new String[] {
			MOC_D, MOC_A, MOC_B, MOC_L, MOC_C, MOC_H, MOC_I, MOC_R, MOC_E,
	...
	public static List<String> smsRegionCodes = Arrays.asList(new String[] {
			MRC_A, MRC_S, MRC_B, MRC_D, MRC_G, MRC_H, MRC_I, MRC_J, MRC_X,
	...
	public static List<String> smsBankCodes = Arrays.asList(new String[] {
			B_HDFCBK, B_CBSSBI, B_ATMSBI, B_SBIPSG, B_SBIINB, B_SBICRD,
	...
	public static List<String> knownSMSBankingAddressCodes = Arrays
			.asList(new String[] { TD_HDFCBK, BT_HDFCBK, DZ_HDFCBK, AM_HDFCBK,
