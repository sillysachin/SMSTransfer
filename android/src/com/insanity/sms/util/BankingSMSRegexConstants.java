...
public class BankingSMSRegexConstants {
    ...
    public static List<String> smsOperatorCodes = Arrays.asList(new String[]{MOC_D, MOC_A, MOC_B, MOC_L, MOC_C, MOC_H, MOC_I, MOC_R, MOC_E, MOC_S, MOC_Y, MOC_P, MOC_W, MOC_T, MOC_U, MOC_V});
    //Region Code
    ...
    public static List<String> smsRegionCodes = Arrays.asList(new String[]{MRC_A, MRC_S, MRC_B, MRC_D, MRC_G, MRC_H, MRC_I, MRC_J, MRC_X, MRC_L, MRC_K, MRC_Y, MRC_Z, MRC_M, MRC_N, MRC_O, MRC_P, MRC_R, MRC_T, MRC_E, MRC_W, MRC_V});
    ...
    public static List<String> smsBankCodes = Arrays.asList(new String[]{B_HDFCBK,
            B_CBSSBI, B_ATMSBI, B_SBIPSG, B_SBIINB, B_SBICRD, B_SBGMBS, B_CBSSBM, B_SBILOS,
            B_AXISBK,
            B_CANBNK,
            B_VIJBNK,
            B_KOTAKB, B_KOTAKS,
    ...
    public static List<String> smsBankingAddressCodes = Arrays.asList(new String[]{
            TD_HDFCBK, BT_HDFCBK, DZ_HDFCBK, AM_HDFCBK, MD_HDFCBK, DM_HDFCBK, LM_HDFCBK,
            DM_SBICRD, MD_SBICRD, BZ_SBICRD, BX_ATMSBI, BZ_ATMSBI, BZ_CBSSBI, BX_CBSSBI, MD_SBIPSG, DM_SBGMBS, LM_SBIINB, BX_SBIINB, BX_SBILOS,
            BZ_CBSSBM, BX_CBSSBM,
            DZ_AXISBK, DM_AXISBK, LM_AXISBK, MD_AXISBK,
            BZ_VIJBNK, MD_VIJBNK, LM_VIJBNK,
            BX_CANBNK,
            DM_KOTAKB, VM_KOTAKB, DZ_KOTAKB, LM_KOTAKB, LM_KOTAKS, VM_KOTAKS,
            LM_CITIBK, MD_CITIBK,
            BT_CORPBK,
            LM_ICICIB});
